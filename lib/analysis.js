        ...
        for (let position of positions.slice(1)) {
            ...
            if (topMove.moveUCI == position.move.uci) {
                ...
                if (noMate) {
                    ...
                    position.classification = classification_1.Classification.MISS;
                }
            ...
            (_c = position.classification) !== null && _c !== void 0 ? _c : (position.classification = classification_1.Classification.EXCELLENT);
        }
